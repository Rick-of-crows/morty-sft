...
def build_tokenizer(args):
    ...
    assert args.vocab_file is not None or args.tokenizer_type == "PretrainedFromHF" or args.tokenizer_type == "LlamaTokenizer"
    if args.tokenizer_type == 'BertWordPieceLowerCase':
        ...
        tokenizer = _LlamaTokenizer(args.tokenizer_name_or_path, vocab_extra_ids=args.vocab_extra_ids)
...
class _LlamaTokenizer(AbstractTokenizer):
    ...
    def __init__(self, tokenizer_name_or_path, vocab_extra_ids):
        ...
        # add by yanc ,with  legacy=False to handle </s> <s> special tokens,  llama2 default add bos in front of sentence, disable it
        #self.tokenizer = LlamaTokenizer.from_pretrained(tokenizer_name_or_path, add_bos_token=False, add_eos_token=False, legacy=False)
        self.tokenizer = LlamaTokenizer.from_pretrained(tokenizer_name_or_path, add_bos_token=True, add_eos_token=True, legacy=False)
