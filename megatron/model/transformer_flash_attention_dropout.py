...
def flash_attn_qkvpacked_func(qkv, bias=None, causal=True, softmax_scale=None, dropout_p=0):
    return FlashAttnQKVPackedFunc.apply(qkv, bias, causal, softmax_scale, dropout_p)
...
class ParallelAttention(MegatronModule):
    ...
    def forward(self, hidden_states, attention_mask, layer_past=None,
        ...
        if self.attention_type == AttnType.self_attn:
            ...
            # output: [b, sq, np, hn]
            output=flash_attn_qkvpacked_func(mixed_x_layer, bias=matmul_result, causal=True, softmax_scale=None, dropout_p=self.attention_dropout)
