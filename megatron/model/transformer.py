...
class ParallelAttention(MegatronModule):
    ...
    def __init__(self, init_method,
        ...
        self.use_flash_att = (os.environ.get("USE_FLASH_ATT") == '1')
    ...
    def flash_attention(self, query_layer, key_layer, value_layer, matmul_result, output_size, p):
        ...
        context_layer = flash_attn_func(query_layer, key_layer, value_layer,matmul_result, True,1./self.norm_factor, p, self.layer_number)
    ...
    def forward(self, hidden_states, attention_mask, layer_past=None,
        ...
        if self.use_flash_att:
            if self.apply_query_key_layer_scaling:
                ...
                beta = 1.0
            context_layer = self.flash_attention(query_layer, key_layer, value_layer, matmul_result*beta, output_size, self.dropout_p)
        else:
