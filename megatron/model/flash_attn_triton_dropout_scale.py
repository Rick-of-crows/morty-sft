...
def _fwd_kernel(
    ...
    for start_n in range(0, end_n, BLOCK_N):
        ...
        # todo, merge offs_n and offs_n_iter for save SRAM/register - wsf
        ...
        if BIAS_TYPE != 'none':
            ...
            qk = qk * softmax_scale / scale + bias / scale
            qk = qk * scale
...
def _bwd_kernel_one_col_block(
    ...
    # dont use `accumulate dKj and dVj in half precision to save SRAM/registers.` here as the github issue
...
def _flash_attn_forward(q, k, v, bias=None, causal=False, dropout_p=0.0, softmax_scale=None, scale=1):
    # shape constraints
...
def _flash_attn_backward(do, q, k, v, o, lse, dq, dk, dv, bias=None, causal=False, dropout_p=0.0, rng_seed=None, rng_offset=None, softmax_scale=None, scale=1):
...
class FlashAttnQKVPackedFunc(torch.autograd.Function):
    ...
    @staticmethod
    def forward(ctx, qkv, bias=None, causal=False, softmax_scale=None, dropout_p: float = 0.0, scale=1):
        """
