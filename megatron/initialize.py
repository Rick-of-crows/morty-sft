...
def _compile_dependencies():
    ...
    if torch.distributed.get_rank() == 0:
        ...
        print('> after loading fused kernels ...', flush=True)
...
def _initialize_distributed():
    ...
    if torch.distributed.is_initialized():
        ...
        if device_count > 0:
            ...
            # print("device is {}, local-rank is {}.".format(device, args.rank))
		...
		# set timeout to 5400s @yanc
        deepspeed.init_distributed(args.distributed_backend,timeout=datetime.timedelta(seconds=5400))
