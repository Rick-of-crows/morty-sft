...
CHECKPOINT_PATH=/workspace/download/downloads/bloomz-mt
SAVE_CHECKPOINT_PATH=/workspace/bloomz-mt-sd
DATA_PATH=data/alpaca-data/my-gpt2_text_document 
...
export CMD=" \
    $LAUNCHER run_convert_bloom_to_deepspeed_no_initialize_load_all.py \
