...
def layer_name_mapping(key, file):
    ...
    layer_number -= 3
    return f"transformer.h.{layer_number}." + key
...
def convert_bloom_checkpoint_to_pytorch(
    ...
    if shard_model:
        ...
        for j, file in enumerate(file_names):
            ...
            # add for falcon lm_head
            if 'transformer.word_embeddings.weight' in tensors.keys():
                tensors['lm_head.weight'] = tensors['transformer.word_embeddings.weight']
