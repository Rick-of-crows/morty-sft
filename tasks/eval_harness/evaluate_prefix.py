...
from pretrain_prefix_lm import model_provider
import numpy as np
...
def load_ds_checkpoint_and_setup_megatron(args):
    ...
    if args.deepspeed:
        ...
        _, _ = model.load_checkpoint(cp_path, tag = None, load_optimizer_states=False, load_lr_scheduler_states=False, load_module_only=True)
