...
#CHECKPOINT_PATH=/workspace/7b-model/bloomz-7b1-optimizer-states
CHECKPOINT_PATH=/workspace/7b-model/bloomz-7b-step276700
#CHECKPOINT_PATH=/workspace/7b-model/bloomz-7b-nemo-step105000
SAVE_CHECKPOINT_PATH=/workspace/$DATE/bloomz-7b$TAG
#DATA_PATH=data/cw/cw_total_v7_text_document
DATA_PATH=data/cw/cw_pretrain_v3_text_document #cw_pretrain_v3_text_document
...
TRAIN_ITERS=9948 #source iter
#use old
LR_DECAY_ITERS=9450
LR_WARMUP_ITERS=298 # use old
