...
CHECKPOINT_PATH=/workspace/yanc/models/bloomchat-meg-ds
#SAVE_CHECKPOINT_PATH=/data/output_dir/$DATE/bloomz-176-cw-sft-pretrain-2
SAVE_CHECKPOINT_PATH=/data/yanc/output_dir/$DATE/bloomz-176-cw-sft-bloomchat
DATA_PATH=data/cw/cw_total_pretrain_text_document
TENSORBOARD_PATH=/data/yanc/output_dir/tensorboard/$DATE-bloomz-176-cw-sft-bloomchat

KILL_SWITCH_PATH=/data/yanc/output_dir/kill-switch-tr11-bloomz-176B-cw-sft-bloomchat
