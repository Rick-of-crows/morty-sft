...
CHECKPOINT_PATH=/workspace/yanc/bloom/bloomz-7b-cw-pretrain-v5-math
#CHECKPOINT_PATH=/workspace/yanc-share/2023-05-29/bloomz-7b-cw-pretrain-v5-math
SAVE_CHECKPOINT_PATH=output_dir/$DATE/bloomz-7b-cw-padding-v16
# merge 2stage
#DATA_PATH=data/cw/cw_total_pretrain_text_document
DATA_PATH=data/cw/cw_total_v16_text_document
...
TRAIN_ITERS=17910 #source iter
#use old
LR_DECAY_ITERS=17014
LR_WARMUP_ITERS=538 # use old
