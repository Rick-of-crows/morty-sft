...
CHECKPOINT_PATH=/workspace/yanc/models/xuanyuan-meg-ds-bf16
#SAVE_CHECKPOINT_PATH=/data/output_dir/$DATE/bloomz-176-cw-sft-pretrain-2
SAVE_CHECKPOINT_PATH=/data/yanc/output_dir/$DATE/bloomz-176-cw-sft-xuanyuan
DATA_PATH=data/cw/cw_total_pretrain_text_document
TENSORBOARD_PATH=/data/yanc/output_dir/tensorboard/$DATE-bloomz-176-cw-sft-xuanyuan

KILL_SWITCH_PATH=/data/yanc/output_dir/kill-switch-tr11-bloomz-176B-cw-sft-xuanyuan
