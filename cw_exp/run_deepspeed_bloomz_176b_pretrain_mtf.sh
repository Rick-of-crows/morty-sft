...
CHECKPOINT_PATH=/workspace/bloomz-176
SAVE_CHECKPOINT_PATH=/workspace/yanc-share/output_dir/$DATE/bloomz-176-cw-pretrain
DATA_PATH=data/cw/cw_total_pretrain_text_document
TENSORBOARD_PATH=/workspace/yanc-share/output_dir/tensorboard/$DATE-bloomz-176-cw-pretrain

KILL_SWITCH_PATH=/workspace/yanc-share/output_dir/kill-switch-tr11-bloomz-176B-pretrain-exp
...
GPT_ARGS=" \
    ...
    $OPTIMIZER_ARGS \
    "
    #--abort-on-unmet-fused-kernel-constraints \  # this need mbs>1
